...
exports.validateSalary = exports.paySalary = exports.getSalaryReport = exports.deleteSalary = exports.updateSalary = exports.createSalary = exports.getSalaryById = exports.getSalaries = void 0;
...
const createSalary = async (req, res) => {
    try {
        ...
        const { employeeId, paymentDate, baseSalary, overtime, bonuses, allowances, socialContributions, taxes, otherDeductions, notes } = req.body;
...
const updateSalary = async (req, res) => {
    try {
        ...
        const { paymentDate, baseSalary, overtime, bonuses, allowances, socialContributions, taxes, otherDeductions, notes } = req.body;
...
async function createSalaryAccountingEntries(salaryId, grossSalary, totalDeductions, netSalary, userId) {
    const entries = [];
