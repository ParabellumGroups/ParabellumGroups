...
exports.validateMessage = exports.replyToMessage = exports.archiveMessage = exports.markAsRead = exports.createMessage = exports.getMessageById = exports.getMessages = void 0;
...
const createMessage = async (req, res) => {
    try {
        ...
        const { recipientId, subject, content, priority, type, attachments } = req.body;
...
exports.validateMessage = [
    (0, express_validator_1.body)('recipientId').isInt().withMessage('Destinataire requis'),
    (0, express_validator_1.body)('subject').notEmpty().withMessage('Sujet requis'),
    (0, express_validator_1.body)('content').notEmpty().withMessage('Contenu requis'),
    (0, express_validator_1.body)('priority').optional().isIn(['low', 'normal', 'high', 'urgent']).withMessage('Priorité invalide'),
    (0, express_validator_1.body)('type').optional().isIn(['internal', 'external', 'system']).withMessage('Type invalide')
];
