...
exports.validateIntervention = exports.removeTechnicien = exports.assignTechnicien = exports.endIntervention = exports.startIntervention = exports.deleteIntervention = exports.updateIntervention = exports.createIntervention = exports.getInterventionById = exports.getInterventions = void 0;
...
const getInterventions = async (req, res) => {
    try {
        ...
        if (search) {
            whereClause.OR = [
                { mission: { numIntervention: { contains: search, mode: 'insensitive' } } },
                { mission: { objectifDuContrat: { contains: search, mode: 'insensitive' } } },
...
const createIntervention = async (req, res) => {
    try {
        ...
        const { dateHeureDebut, dateHeureFin, missionId, commentaire, techniciens, materiels } = req.body;
...
const updateIntervention = async (req, res) => {
    try {
        ...
        const { dateHeureDebut, dateHeureFin, commentaire, statut } = req.body;
...
exports.startIntervention = startIntervention;
...
exports.endIntervention = endIntervention;
...
exports.assignTechnicien = assignTechnicien;
const removeTechnicien = async (req, res) => {
    try {
...
exports.removeTechnicien = removeTechnicien;
// Validation middleware
exports.validateIntervention = [
    (0, express_validator_1.body)('dateHeureDebut').isISO8601().withMessage('Date de début invalide'),
    (0, express_validator_1.body)('dateHeureFin').optional().isISO8601().withMessage('Date de fin invalide'),
    (0, express_validator_1.body)('missionId').notEmpty().withMessage('Mission requise'),
    (0, express_validator_1.body)('techniciens').isArray({ min: 1 }).withMessage('Au moins un technicien requis'),
    (0, express_validator_1.body)('techniciens.*.technicienId').isInt().withMessage('ID technicien invalide'),
    (0, express_validator_1.body)('techniciens.*.role').isIn(['Principal', 'Assistant']).withMessage('Rôle invalide')
];
