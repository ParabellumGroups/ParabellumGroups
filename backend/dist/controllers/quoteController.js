...
exports.validateQuote = exports.rejectQuote = exports.approveByDG = exports.approveByServiceManager = exports.submitForServiceApproval = exports.createQuote = exports.getQuoteById = exports.getQuotes = void 0;
...
const createQuote = async (req, res) => {
    try {
        ...
        const { customerId, customerAddressId, quoteDate, validUntil, terms, notes, items } = req.body;
...
const submitForServiceApproval = async (req, res) => {
    try {
        const { id } = req.params;
        const quote = await prisma.quote.findUnique({
            where: { id: Number(id) },
...
exports.submitForServiceApproval = submitForServiceApproval;
const approveByServiceManager = async (req, res) => {
    try {
        const { id } = req.params;
...
exports.approveByServiceManager = approveByServiceManager;
const approveByDG = async (req, res) => {
    try {
        const { id } = req.params;
        const { comments } = req.body;
...
exports.approveByDG = approveByDG;
...
exports.validateQuote = [
    ...
    (0, express_validator_1.body)('quoteDate').isISO8601().withMessage('Date de devis invalide'),
    (0, express_validator_1.body)('validUntil').isISO8601().withMessage('Date de validité invalide'),
