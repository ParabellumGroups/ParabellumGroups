...
exports.swaggerTags = exports.setupSwagger = void 0;
...
const setupSwagger = (app) => {
    try {
        ...
        logger_1.logger.info('📚 Documentation Swagger configurée sur /api-docs');
    }
    catch (error) {
        logger_1.logger.error('❌ Erreur lors de la configuration de Swagger:', error);
    }
};
