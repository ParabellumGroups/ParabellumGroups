...
exports.CURRENCY = exports.DATE_FORMATS = exports.ERROR_MESSAGES = exports.LIMITS = exports.TIMEOUTS = exports.isTest = exports.isProduction = exports.isDevelopment = exports.config = void 0;
...
const validateEnvironment = () => {
    ...
    if (missingVars.length > 0) {
        logger_1.logger.error('❌ Variables d\'environnement manquantes:', missingVars);
        process.exit(1);
    }
    logger_1.logger.info('✅ Variables d\'environnement validées');
};
...
exports.LIMITS = {
    ...
    MAX_UPLOAD_SIZE: exports.config.MAX_FILE_SIZE,
